...
/**
 * Dispense activitytypes based on the provided YAML File
 */
public class CQLYamlActivityDispenser implements ActivityDispenser<CQLYamlActivity> {
    private static final Logger logger = LoggerFactory.getLogger(CQLYamlActivityDispenser.class);
     ...
     */
    public CQLYamlActivityDispenser(ActivityDef activityDef, String fromPath, InputStream stream) {
