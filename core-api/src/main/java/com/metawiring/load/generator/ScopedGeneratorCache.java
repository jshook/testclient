...
/**
 * Provide a cache of generator cache instances, with nested scope.
 * Provides warnings or errors as requested if generators are already defined in an enclosing
...
public class ScopedGeneratorCache implements ScopedCachingGeneratorSource {
    ...
    @Override
    public ScopedGeneratorCache enterScope(RuntimeScope subScope) {
    ...
    private ScopedGeneratorCache(ScopedGeneratorCache parentCache, RuntimeScope subScope) {
        ...
        this.cacheList.addFirst(
                new ScopedGeneratorLevel(
                        subScope,
                        new CachingGeneratorSourceImpl(parentCache.generatorInstantiator)
                ));
    }
