...
public class YamlActivityDef {
    ...
    private List<StatementDef> ddl = new ArrayList<>();
    private List<StatementDef> dml = new ArrayList<>();
    ...
    public void setParams(Map<String,String> param) { this.params = params; }
